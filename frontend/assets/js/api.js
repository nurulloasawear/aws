...
document.addEventListener('DOMContentLoaded', function () {
  fetch('http://13.60.5.226:8000/units/')  // API endpointingiz shu bo‘lishi kerak
...
function fetchAndRenderUnits() {
  fetch('http://13.60.5.226:8000/units/')
    .then(response => {
...
function fetchProjects() {
  fetch('http://13.60.5.226:8000/api/projects')
    .then(response => response.json())
    .then(data => {
      ...
      const baseUrl = "http://13.60.5.226:8000/";
